...
public class Constants {
	...
	public static String USER_NAME = "bayle-sa"; // votre nom d'utilisateur : XXX
	public static String PASS_WORD = "/RHWrF"; // votre mot de passe . XXX
	...
	public static String CT_BASE_NAME = "ct-tpgei-virt-D6-ct";  // "XX" � remplacer par votre num�ro de bin�me. Exemple: ct-tpgei-virt-A3-ct � concat�ner avec le num�ro du CT
	public static long CT_BASE_ID = 46;	 // � modifier (cf. sujet de tp) XXX
